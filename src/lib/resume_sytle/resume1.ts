    ...
    paragraphArr: [
      {
        ...
        id: uuidv4(),
        label:
          '<ul><ul><li><span style="font-size: 16px;">熟练掌握html5、JavaScript、css3、vue、angularjs等前端技术</span></li><li><span style="font-size: 16px;">熟练掌握nodejs、nginx、ajax、Bootstrap等技术</span></li><li><span style="color: rgb(50, 50, 51); background-color: rgb(255, 255, 255); font-size: 16px;">熟练掌握HTML5各种新特性, 能够实现基本绘图，地理定位，SVG绘图</span></li><li><span style="color: rgb(50, 50, 51); background-color: rgb(255, 255, 255); font-size: 16px;">熟练掌握各种js函数库和框架: 包括jQuery, Ajax, boot,,能够使用jQuery简化DOM操作</span></li><li><span style="color: rgb(50, 50, 51); background-color: rgb(255, 255, 255); font-size: 16px;">熟悉PHP,Mysql,HTTP协议，能够使用PHP和Mysql实现服务器端功能，访问数据库。</span></li><li><span style="color: rgb(50, 50, 51); background-color: rgb(255, 255, 255); font-size: 16px;">精通JS，DOM，BOM等原生js代码，能够使用原生代码开发页面功能。</span></li></ul></ul>',
        name: "",
        position: "",
        startTime: "",
        style: { fontSize: "16px" },
